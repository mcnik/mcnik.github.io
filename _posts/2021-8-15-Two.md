...
If we accept that the future is inevitable, we can start thinking about things to do while we wait. Because this future is inevitable. Moving things is a much bigger market than moving people so [self-driving trucks](https://www.wired.com/story/trucks-move-past-cars-road-autonomy/) might arrive much before self-driving cars. I think making AI-driven cars look different from human-driven cars is a good first step&nbsp;[^7]. One thing I have not touched on at all is the issue of insurance.  How do you demonstrate who/what caused an accident with a self-driving car? Increasing transparency in self-driving car operations will increase trust and help build more robust self-driving cars.
